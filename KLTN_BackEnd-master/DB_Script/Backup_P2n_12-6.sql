...
CREATE TABLE `brandproduct` (
  ...
  CONSTRAINT `brandproduct_ibfk_1` FOREIGN KEY (`brandid`) REFERENCES `brand` (`id`),
  CONSTRAINT `brandproduct_ibfk_2` FOREIGN KEY (`productdetailid`) REFERENCES `productdetail` (`id`)
...
INSERT INTO `brandproduct` VALUES (1,2,1,2,10,1,'2022-04-24 18:07:30',1,'2022-04-24 18:07:30'),(2,3,1,2,10,1,'2022-04-24 18:15:49',1,'2022-04-24 18:15:49'),(3,4,1,2,10,1,'2022-04-24 19:16:50',1,'2022-04-24 19:16:50'),(4,1,1,4,10,1,'2022-04-24 19:18:21',1,'2022-04-24 19:18:21'),(5,1,2,3,10,1,'2022-04-24 19:18:21',1,'2022-04-24 19:18:21');
...
CREATE TABLE `cartitem` (
  ...
  PRIMARY KEY (`id`),
  KEY `cartid` (`cartid`),
  KEY `petdetailid` (`productdetailid`),
  KEY `orderid` (`orderid`),
  KEY `brandid` (`brandid`),
  CONSTRAINT `cartitem_ibfk_1` FOREIGN KEY (`cartid`) REFERENCES `cart` (`id`),
  CONSTRAINT `cartitem_ibfk_2` FOREIGN KEY (`productdetailid`) REFERENCES `productdetail` (`id`),
  CONSTRAINT `cartitem_ibfk_3` FOREIGN KEY (`orderid`) REFERENCES `order` (`id`),
  CONSTRAINT `cartitem_ibfk_4` FOREIGN KEY (`brandid`) REFERENCES `brand` (`id`)
...
CREATE TABLE `category` (
  ...
  `updatedate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `typerootid` (`categoryrootid`),
  KEY `typeproductid` (`typeproductid`),
  CONSTRAINT `category_ibfk_1` FOREIGN KEY (`categoryrootid`) REFERENCES `category` (`id`),
  CONSTRAINT `category_ibfk_2` FOREIGN KEY (`typeproductid`) REFERENCES `typeproduct` (`id`)
...
CREATE TABLE `chatcontent` (
  ...
  CONSTRAINT `chatcontent_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`),
  CONSTRAINT `chatcontent_ibfk_2` FOREIGN KEY (`chatroomid`) REFERENCES `chatroom` (`id`)
...
CREATE TABLE `chatroomuser` (
  ...
  KEY `chatroomid` (`chatroomid`),
  KEY `userid` (`userid`),
  CONSTRAINT `chatroomuser_ibfk_1` FOREIGN KEY (`chatroomid`) REFERENCES `chatroom` (`id`),
  CONSTRAINT `chatroomuser_ibfk_2` FOREIGN KEY (`userid`) REFERENCES `users` (`id`)
...
CREATE TABLE `news` (
  ...
  `updatedate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `typenews` (`typenewsid`),
  CONSTRAINT `news_ibfk_1` FOREIGN KEY (`typenewsid`) REFERENCES `typenews` (`id`)
...
CREATE TABLE `order` (
  ...
  KEY `statuspaymentid` (`statuspaymentid`),
  ...
  CONSTRAINT `order_ibfk_4` FOREIGN KEY (`typepaymentid`) REFERENCES `typepayment` (`id`),
  CONSTRAINT `order_ibfk_5` FOREIGN KEY (`statuspaymentid`) REFERENCES `statuspayment` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product` (
  ...
  KEY `typeproductid` (`categoryid`),
  CONSTRAINT `product_ibfk_1` FOREIGN KEY (`breedid`) REFERENCES `breed` (`id`),
  CONSTRAINT `product_ibfk_2` FOREIGN KEY (`supplierid`) REFERENCES `supplier` (`id`),
  CONSTRAINT `product_ibfk_3` FOREIGN KEY (`categoryid`) REFERENCES `category` (`id`)
...
CREATE TABLE `productcomment` (
  ...
  KEY `userid` (`userid`),
  KEY `petdetailid` (`productdetailid`),
  KEY `commentrootid` (`commentrootid`),
  CONSTRAINT `productcomment_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `users` (`id`),
  CONSTRAINT `productcomment_ibfk_2` FOREIGN KEY (`productdetailid`) REFERENCES `productdetail` (`id`),
  CONSTRAINT `productcomment_ibfk_3` FOREIGN KEY (`commentrootid`) REFERENCES `productcomment` (`id`)
...
CREATE TABLE `productdetail` (
  ...
  CONSTRAINT `productdetail_ibfk_1` FOREIGN KEY (`productid`) REFERENCES `product` (`id`),
  CONSTRAINT `productdetail_ibfk_2` FOREIGN KEY (`colorid`) REFERENCES `color` (`id`),
  CONSTRAINT `productdetail_ibfk_3` FOREIGN KEY (`sizeid`) REFERENCES `size` (`id`),
  CONSTRAINT `productdetail_ibfk_4` FOREIGN KEY (`ageid`) REFERENCES `age` (`id`),
  CONSTRAINT `productdetail_ibfk_5` FOREIGN KEY (`sexid`) REFERENCES `sex` (`id`),
  CONSTRAINT `productdetail_ibfk_6` FOREIGN KEY (`statusdetailid`) REFERENCES `statusdetail` (`id`)
...
INSERT INTO `productdetail` VALUES (1,1,1,2,1,1,1,5600000,10,3,10,1,'2021-12-17 16:42:33',1,'2022-06-11 19:03:35'),(2,1,2,4,7,2,1,15000000,8,4,10,1,'2021-12-17 16:55:17',1,'2022-06-04 05:22:38'),(3,2,3,1,2,1,1,6000000,8,5,10,1,'2021-12-17 17:00:13',24,'2022-01-02 23:38:19'),(4,2,4,1,1,2,1,10000000,15,6,10,1,'2021-12-17 17:03:45',1,'2022-05-15 10:33:09'),(5,3,5,2,1,2,1,5500000,5,5,10,1,'2021-12-17 17:09:45',1,'2022-06-10 17:42:33'),(6,3,7,4,6,1,1,12500000,15,6,10,1,'2021-12-17 17:13:18',1,'2022-06-10 15:45:08'),(7,4,4,4,6,1,1,14000000,10,5,10,1,'2021-12-17 17:16:42',1,'2022-05-15 08:19:32'),(8,4,6,2,1,2,1,4000000,10,5,10,1,'2021-12-17 21:19:54',1,'2021-12-17 21:19:54'),(9,5,7,4,7,1,1,12500000,8,6,10,1,'2021-12-17 21:28:37',19,'2022-01-06 21:29:02'),(10,6,8,4,7,1,1,10500000,8,5,10,1,'2021-12-17 21:34:44',8,'2022-01-02 22:31:10'),(11,7,4,2,2,1,3,7500000,12,5,10,1,'2021-12-17 21:40:41',1,'2022-05-15 05:37:13'),(12,8,6,2,1,1,1,12000000,10,10,10,1,'2021-12-17 21:46:15',1,'2022-06-04 05:22:38'),(13,8,7,4,8,1,1,22000000,15,4,10,1,'2021-12-17 21:49:16',1,'2022-06-11 16:05:47'),(14,9,4,3,5,2,1,15500000,5,4,10,1,'2021-12-17 21:54:21',17,'2022-01-02 20:58:05'),(15,9,4,1,1,1,1,7000000,4,8,10,1,'2021-12-17 21:57:32',1,'2022-05-15 05:37:13'),(16,10,9,3,4,1,1,13000000,9,2,10,1,'2021-12-17 22:04:02',1,'2021-12-17 22:04:43'),(17,11,6,2,1,2,1,5500000,2,4,10,1,'2021-12-17 22:09:53',1,'2021-12-17 22:09:53'),(18,12,10,3,3,1,1,4500000,4,7,10,1,'2021-12-17 22:22:34',11,'2022-01-06 21:41:12'),(19,13,6,1,1,1,1,1200000,15,1,10,1,'2021-12-17 22:40:19',1,'2022-06-12 15:43:53'),(20,14,1,3,3,2,1,2500000,9,6,10,1,'2021-12-17 22:43:09',1,'2022-05-15 10:10:46'),(21,15,9,3,4,2,1,1200000,7,11,10,1,'2021-12-17 22:49:06',19,'2022-01-02 20:41:42'),(22,1,1,3,6,2,1,14500000,8,8,10,1,'2021-12-26 15:03:24',19,'2022-01-06 21:27:44'),(23,1,2,2,1,1,1,6000000,8,7,10,1,'2021-12-26 15:07:14',1,'2021-12-26 15:07:58'),(24,7,2,2,1,1,1,6500000,9,5,10,1,'2021-12-26 15:13:00',1,'2022-05-31 01:02:43'),(25,8,6,4,6,1,3,20000000,12,0,10,1,'2021-12-26 15:18:13',1,'2022-05-15 06:11:26'),(26,5,7,2,1,2,3,6500000,12,8,10,1,'2021-12-26 15:22:01',1,'2022-06-01 16:33:23'),(27,2,3,3,5,2,1,9000000,10,4,10,1,'2021-12-26 15:44:12',1,'2022-05-15 10:33:09'),(28,3,5,3,5,2,1,9500000,7,4,10,1,'2021-12-26 15:47:02',1,'2021-12-26 15:47:43'),(29,3,4,3,5,1,1,12000000,5,6,10,1,'2021-12-26 15:51:17',17,'2022-01-02 20:56:43'),(30,4,4,2,1,1,1,8000000,6,6,10,1,'2021-12-26 15:54:33',19,'2022-01-06 21:21:14'),(31,10,9,2,1,1,1,7000000,5,7,10,1,'2021-12-26 15:57:37',1,'2021-12-26 15:57:37'),(32,11,5,2,1,1,1,5000000,6,4,10,1,'2021-12-26 16:01:35',1,'2022-05-15 07:21:45'),(33,15,4,4,6,1,1,4000000,10,9,10,1,'2021-12-26 16:05:13',13,'2022-01-06 21:32:19'),(34,13,10,2,3,2,1,2300000,5,6,10,1,'2021-12-26 16:07:24',1,'2022-06-12 14:43:15'),(35,13,6,1,2,1,3,3200000,12,3,10,1,'2021-12-26 16:09:41',1,'2022-06-01 16:33:23'),(36,14,4,2,2,1,1,4000000,7,8,10,1,'2021-12-26 16:12:44',1,'2021-12-26 16:12:44'),(37,7,1,2,1,1,1,1200000,10,2,90,1,'2022-02-02 14:15:14',1,'2022-02-02 14:16:19'),(38,17,NULL,6,NULL,NULL,1,65000,0,50,10,1,NULL,1,NULL);
...
CREATE TABLE `productimagefor` (
  ...
  KEY `petimageid` (`productimageid`),
  KEY `petdetailid` (`productdetailid`),
  CONSTRAINT `productimagefor_ibfk_1` FOREIGN KEY (`productimageid`) REFERENCES `productimage` (`id`),
  CONSTRAINT `productimagefor_ibfk_2` FOREIGN KEY (`productdetailid`) REFERENCES `productdetail` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=112 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `size` (
  ...
  PRIMARY KEY (`id`),
  KEY `typeproductid` (`typeproductid`),
  CONSTRAINT `size_ibfk_1` FOREIGN KEY (`typeproductid`) REFERENCES `typeproduct` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `size` VALUES (1,'Rất nhỏ',1,NULL,10,1,'2021-12-16 20:36:12',1,'2021-12-16 20:36:12'),(2,'Nhỏ',2,NULL,10,1,'2021-12-16 20:36:27',1,'2021-12-16 20:36:27'),(3,'Trung bình',3,NULL,10,1,'2021-12-16 20:36:41',1,'2021-12-16 20:36:41'),(4,'Lớn',4,NULL,10,1,'2021-12-16 20:36:56',1,'2021-12-16 20:36:56'),(5,'Rất lớn',5,NULL,10,1,'2021-12-16 20:37:37',1,'2021-12-16 20:37:37'),(6,'300g',1,20,10,1,NULL,1,NULL),(7,'500g',2,20,10,1,NULL,1,NULL),(8,'750g',3,20,10,1,NULL,1,NULL),(9,'1kg',4,20,10,1,NULL,1,NULL),(10,'1,5 kg',5,20,10,1,NULL,1,NULL);
...
INSERT INTO `typepayment` VALUES (10,'Thanh toán khi lấy hàng',10),(20,'Momo',10);
...
INSERT INTO `typeproduct` VALUES (10,'Thú cưng',10),(20,'Thức ăn',10),(30,'Phụ kiện',10),(40,'Chuồng nuôi thú cưng',10);
...
-- Dump completed on 2022-06-12 16:12:20
